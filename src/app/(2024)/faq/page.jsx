      ...
      <div className="container">
        <Wrapper>
          ...
          <TextWrapper className="text-wrap">
            <p >
              <span className="fig">figbruary</span> is an finctional month created by combining
              Figma + February where you can experiment and design things daily
              to push the limits
            </p>
            <p>
              For every 24 hour day within this 672 hour timespan, we have
